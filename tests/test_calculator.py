...
class TestInvalid:
    ...
    def test_add_invalid_input_MaxValue_a(self, calc):
    ...
    def test_add_max_boundary_b(self, calc):
        assert calc.add(1, 1000000) == 1000001
...
# ~/.local/bin/mutmut run
# ~/.local/bin/mutmut browse
